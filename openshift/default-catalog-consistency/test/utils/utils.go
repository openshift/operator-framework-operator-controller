...
// LoadImagesFromCatalogs reads the catalogs from the files used and returns a list of image references.
func LoadImagesFromCatalogsFrom(catalogsPath string) ([]string, error) {
	var images []string
