...
$YQ -i ".namespace = \"${NAMESPACE}\"" "${TMP_CONFIG}/base/operator-controller/kustomization.yaml"
...
$KUSTOMIZE build "${TMP_CONFIG}/base/operator-controller" -o "$TMP_KUSTOMIZE_OUTPUT"
