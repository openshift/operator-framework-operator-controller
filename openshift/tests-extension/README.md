...
Before running any test that interacts with the cluster,
initialize the environment using env.Init() inside a BeforeEach block:
...
2. Skip OpenShift-specific logic on vanilla Kubernetes
