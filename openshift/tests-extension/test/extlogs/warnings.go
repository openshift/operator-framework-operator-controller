...
func Warn(msg string) {
	fmt.Fprintf(ginkgo.GinkgoWriter, "[WARN] %s\n", msg)
}
...
func WarnError(err error) {
	if err != nil {
		fmt.Fprintf(ginkgo.GinkgoWriter, "[WARN] error: %v\n", err)
	}
}
...
func WarnContext(context string, err error) {
	if err != nil {
		fmt.Fprintf(ginkgo.GinkgoWriter, "[WARN] %s: %v\n", context, err)
	}
}
...
func Info(msg string) {
	fmt.Fprintf(ginkgo.GinkgoWriter, "[INFO] %s\n", msg)
}
