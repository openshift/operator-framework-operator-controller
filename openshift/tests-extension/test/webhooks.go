	...
	Ordered, Serial, func() {
		...
		AfterEach(func(ctx SpecContext) {
			if CurrentSpecReport().Failed() {
				...
				helpers.RunAndPrint(ctx, "get", "clusterextension", webhookOperatorInstallNamespace, "-oyaml")
				helpers.RunAndPrint(ctx, "get", "clustercatalog", "webhook-operator-catalog", "-oyaml")
			}
