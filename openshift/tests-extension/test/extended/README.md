...
1. **Case from tests-private Identification**: These cases must be implemented under `openshift/tests-extension/test/extended/specs/`
...
2. **Case from Origin Placement**: These cases should NOT be implemented under `openshift/tests-extension/test/extended/specs/`
