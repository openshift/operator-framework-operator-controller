...
var _ = g.Describe("[sig-olmv1][Jira:OLM] clustercatalog", g.Label("NonHyperShiftHOST", "ClusterCatalog"), func() {
	...
	g.It("PolarionID:69069-[Skipped:Disconnected]Replace pod-based image unpacker with an image registry client", func() {
		var (
			baseDir                = exutil.FixturePath("testdata", "olm")
			clustercatalogTemplate = filepath.Join(baseDir, "clustercatalog.yaml")
			clustercatalog         = olmv1util.ClusterCatalogDescription{
	...
	g.It("PolarionID:69869-[Skipped:Disconnected]Catalogd Add metrics to the Storage implementation", func() {
	...
	g.It("PolarionID:69202-[Skipped:Disconnected][Skipped:Proxy]Catalogd clustercatalog offer the operator content through http server off cluster", g.Label("LEVEL0"), func() {
		exutil.SkipOnProxyCluster(oc)
		var (
			baseDir                = exutil.FixturePath("testdata", "olm")
			clustercatalogTemplate = filepath.Join(baseDir, "clustercatalog.yaml")
	...
	g.It("PolarionID:73219-[Skipped:Disconnected]Fetch deprecation data from the catalogd http server", func() {
		var (
			baseDir                = exutil.FixturePath("testdata", "olm")
			clustercatalogTemplate = filepath.Join(baseDir, "clustercatalog.yaml")
			clustercatalog         = olmv1util.ClusterCatalogDescription{
	...
	g.It("PolarionID:75441-[Skipped:Disconnected]Catalogd supports compression and jsonlines format", func() {
		var (
			baseDir                = exutil.FixturePath("testdata", "olm")
			clustercatalogTemplate = filepath.Join(baseDir, "clustercatalog.yaml")
			clustercatalog         = olmv1util.ClusterCatalogDescription{
	...
	g.It("PolarionID:73289-[Skipped:Disconnected]Check the deprecation conditions and messages", func() {
		var (
			baseDir                      = exutil.FixturePath("testdata", "olm")
			clustercatalogTemplate       = filepath.Join(baseDir, "clustercatalog.yaml")
	...
	g.It("PolarionID:74948-[Skipped:Disconnected]catalog offer the operator content through https server", g.Label("LEVEL0"), func() {
		var (
			baseDir                      = exutil.FixturePath("testdata", "olm")
			clustercatalogTemplate       = filepath.Join(baseDir, "clustercatalog.yaml")
			clusterextensionTemplate     = filepath.Join(baseDir, "clusterextension.yaml")
	...
	g.It("PolarionID:74978-[Skipped:Disconnected]CRD upgrade will be prevented if the Scope is switched between Namespaced and Cluster", g.Label("LEVEL0"), func() {
		var (
			baseDir                      = exutil.FixturePath("testdata", "olm")
			clustercatalogTemplate       = filepath.Join(baseDir, "clustercatalog.yaml")
			clusterextensionTemplate     = filepath.Join(baseDir, "clusterextension.yaml")
	...
	g.It("PolarionID:75218-[Skipped:Disconnected]Disabling the CRD Upgrade Safety preflight checks", func() {
		var (
			baseDir                      = exutil.FixturePath("testdata", "olm")
			clustercatalogTemplate       = filepath.Join(baseDir, "clustercatalog.yaml")
			clusterextensionTemplate     = filepath.Join(baseDir, "clusterextension.yaml")
	...
	g.It("PolarionID:75122-[Skipped:Disconnected]CRD upgrade check Removing an existing stored version and add a new CRD with no modifications to existing versions", func() {
	...
	g.It("PolarionID:75123-[Skipped:Disconnected]CRD upgrade checks for changes in required field and field type", func() {
		exutil.SkipForSNOCluster(oc)
		var (
			caseID                       = "75123"
			labelValue                   = caseID
	...
	g.It("PolarionID:75124-[Skipped:Disconnected]CRD upgrade checks for changes in default values", func() {
		exutil.SkipForSNOCluster(oc)
		var (
			caseID                       = "75124"
			labelValue                   = caseID
	...
	g.It("PolarionID:75515-[Skipped:Disconnected]CRD upgrade checks for changes in enumeration values", func() {
		exutil.SkipForSNOCluster(oc)
		var (
			caseID                       = "75515"
			labelValue                   = caseID
	...
	g.It("PolarionID:75516-[Skipped:Disconnected][Skipped:SNO]CRD upgrade checks for the field maximum minimum changes", g.Label("LEVEL0"), func() {
		exutil.SkipForSNOCluster(oc)
		var (
			caseID                       = "75516"
			labelValue                   = caseID
