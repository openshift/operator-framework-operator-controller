...
func InitTest(dryRun bool) error {
	...
	TestContext.DeleteNamespaceOnFailure = true
...
func createTestingNS(ctx context.Context, baseName string, c kclientset.Interface, labels map[string]string) (*corev1.Namespace, error) {
