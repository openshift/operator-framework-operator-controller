...
func manifestsScriptConfigmapYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "manifests/script.configmap.yaml", size: 275, mode: os.FileMode(420), modTime: time.Unix(1769170913, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
