...
func NewCatalogAndClusterBundles(ctx SpecContext, replacements map[string]string,
	...
	fileOperator, fileCleanup := createTempTarBall(replacements, getAssetNamesBundle, getAssetBundle)
	...
	fileCatalog, fileCleanup := createTempTarBall(replacements, getAssetNamesBundle, getAssetBundle)
	DeferCleanup(fileCleanup)
