...
import (
	...
	"github/operator-framework-operator-controller/openshift-test/default-catalog-consistency/pkg/check"
	"github/operator-framework-operator-controller/openshift-test/default-catalog-consistency/pkg/extract"
	"github/operator-framework-operator-controller/openshift-test/default-catalog-consistency/test/utils"
)
...
var _ = Describe("OLM-Catalog-Validation", func() {
	catalogsPath := "../../../../openshift/catalogd/kustomize/overlays/openshift/catalogs"
