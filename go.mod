...
require (
	...
	github.com/operator-framework/catalogd v0.31.0
...
replace github.com/operator-framework/catalogd => github.com/openshift/operator-framework-catalogd v0.0.0-20241010195114-c3ccd0380aa9
